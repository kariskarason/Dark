...
function shouldSkipUpdate() {
    // If player has bullet time, and cooldown is done, freeze time
    if (eatKey(KEY_PAUSE) && player.bulletTime && player.itemCooldown === 0) {
        console.log('freeze');
        if(g_isUpdatePaused) player.itemCooldown = 2;
